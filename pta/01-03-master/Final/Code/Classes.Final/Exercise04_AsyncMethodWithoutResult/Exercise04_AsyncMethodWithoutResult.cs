...
namespace Classes.Final.Exercise04_AsyncMethodWithoutResult;
...
public class WriterAsync : Exercise0103Base
{
    ...
    */
    ...
    public async Task WriteFileContentAsync()
    {
        string[] sampleFileContent = await File.ReadAllLinesAsync("Exercise04_AsyncMethodWithoutResult/Sample.txt");
        foreach (var fileLine in sampleFileContent)
        {
            WriteLine(fileLine);
        }
    }
